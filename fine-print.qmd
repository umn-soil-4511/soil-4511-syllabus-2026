...
This class is designed to be an active, technology-assisted environment. To that end, the use of personal electronics such as cell phones, tablets or laptops are encouraged during class time. The use of any electronic music players during class time is prohibited unless prior approval has been granted by the instructor.
